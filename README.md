...
공개 공유용 최종 발표자료만 배포하는 GitHub Pages 저장소입니다.
...
- 이 저장소에는 공개 가능한 최종 HTML과 필요한 이미지 에셋만 포함합니다.
- 작업 원본, 발표 기획 문서, 제작 가이드는 비공개 작업 저장소에서 관리합니다.
- 새 발표자료를 공개할 때는 `decks/{deck-id}/` 경로로 추가하고 루트 `index.html`에 링크를 추가합니다.
